...
| `index.html` | página e todo o CSS, em tokens |
...
```bash
python3 -m http.server 8777     # e abrir http://localhost:8777/
```

Dentro da plataforma, a casca serve a pasta em `/m/involutivo/` e abre cada estudo
num `iframe` com `index.html?casca` — veja o `CLAUDE.md` da raiz.
